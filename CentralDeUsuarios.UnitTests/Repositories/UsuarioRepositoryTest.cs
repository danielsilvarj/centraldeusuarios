...
namespace CentralDeUsuarios.UnitTests.Repositories
{
    ...
    public class UsuarioRepositoryTest
    {
        ...
        public void TestCreate()
        {
            ...
            var usuarioById = _usuarioRepository.FindById(usuario.Id);
        ...
        //    var usuario = CreateUsuarioPasswordInvalid();
        ...
        private Usuario CreateUsuarioPasswordInvalid()
        {
            var faker = new Faker("pt_BR");
